...
$(".tools > .UserTools").click(function (e) {
    ...
    $(this).siblings().find(".notficat-body").slideUp();
    $(this).siblings().find(".notficat-body").find(".notficat-body").removeClass("active")
})

// عنصر الاشعارات
$(".tools > .notfications").click(function (e) {
    $(this).siblings().find(".UserPage").slideUp();
    $(this).siblings().find(".UserPage").find(".UserPage").removeClass("active")
    $(this).siblings().removeClass("active");
    $(this).toggleClass("active");
    $(this).find(".notficat-body").slideToggle();
})
